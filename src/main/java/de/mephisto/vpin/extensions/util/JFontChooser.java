  ...
  protected class ListSearchTextFieldDocumentHandler implements DocumentListener {
    ...
    private void update(DocumentEvent event) {
      ...
      if (newValue.length() > 0) {
        ...
        if (newValue.contains(matchedName)) {
...
//              SwingUtilities.invokeLater(new ListSelector(i));
//            }
//            break;
//          }
//        }
  ...
  protected JTextField getSampleTextField() {
    if (sampleText == null) {
      ...
      sampleText = new JTextField(("AaBbYyZz123"));
      sampleText.setBorder(lowered);
      sampleText.setPreferredSize(new Dimension(700, 180));
    }
    return sampleText;
  }
